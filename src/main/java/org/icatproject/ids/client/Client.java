...
import org.icatproject.ids.client.exceptions.BadRequestException;
import org.icatproject.ids.client.exceptions.ForbiddenException;
import org.icatproject.ids.client.exceptions.InsufficientStorageException;
import org.icatproject.ids.client.exceptions.InternalServerErrorException;
import org.icatproject.ids.client.exceptions.NotFoundException;
import org.icatproject.ids.client.exceptions.NotImplementedException;
...
public class Client {
	 ...
	 *            A list of investigation IDs (optional)
	 * @param datasetIds
	 ...
	 * @param zip
	 *            Request data to be packaged in a ZIP archive (optional)
	 * 
	 * @return A preparedId for the download request
	 * 
	 * @throws IOException
	 *             Thrown for problems connecting to the IDS. Check IDS URL.
	 * @throws NotImplementedException
	 *             This method has not been implemented on the IDS.
	 * @throws InternalServerErrorException
	 *             Something has gone wrong. Check IDS server logs.
	 * @throws ForbiddenException
	 *             The request has been refused using sessionId. Check not expired.
	 */
	...
	/**
	 * Sends a request to get the status of a prepareData request.
	 * 
	 * @param preparedId
	 *            The ID of the request
	 * 
	 * @return Current status of the request (ONLINE, INCOMPLETE, RESTORING)
	 * 
	 * @throws IOException
	 *             Thrown for problems connecting to the IDS. Check IDS URL.
	 * @throws NotImplementedException
	 ...
	 *             preparedId not found. Request may have expired.
	 * @throws ForbiddenException
	 *             The request has been refused using sessionId. Check sessionId expired.
	 */
